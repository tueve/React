...
export const REMOVE_AUTOCOMPLETE_PACKAGE =
  'NPMDashBoard/REMOVE_AUTOCOMPLETE_PACKAGE';
export const ADD_PACKAGE = 'NPMDashBoard/ADD_PACKAGE';
export const REMOVE_PACKAGE = 'NPMDashBoard/REMOVE_PACKAGE';
export const GET_PACKAGE_DOWNLOAD_INFO =
  'NPMDashBoard/GET_PACKAGE_DOWNLOAD_INFO';
...
export const SET_CURRENT_PACKAGE = 'NPMDashBoard/SET_CURRENT_PACKAGE';
...
export const GET_README = 'NPMDashBoard/GET_README';
